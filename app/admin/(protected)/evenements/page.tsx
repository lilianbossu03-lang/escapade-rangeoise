        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input type="text" name="titre" required placeholder="Nom de l'événement" className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-base focus:outline-none focus:ring-1 focus:ring-gold/50 focus:border-gold" />
            </div>
            <div>
              <label className="block font-lato text-xs font-semibold text-gray-600 mb-1.5">Date de début *</label>
              <input type="date" name="date" required className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-base focus:outline-none focus:ring-1 focus:ring-gold/50 focus:border-gold" />
            </div>
            <div>
              <label className="block font-lato text-xs font-semibold text-gray-600 mb-1.5">Date de fin</label>
              <input type="date" name="date_fin" className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-base focus:outline-none focus:ring-1 focus:ring-gold/50 focus:border-gold" />
            </div>
            <div>
              <label className="block font-lato text-xs font-semibold text-gray-600 mb-1.5">Lieu *</label>
              <input type="text" name="lieu" required placeholder="Berck-sur-Mer" className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-base focus:outline-none focus:ring-1 focus:ring-gold/50 focus:border-gold" />
            </div>
            <div>
              <label className="block font-lato text-xs font-semibold text-gray-600 mb-1.5">Catégorie *</label>
              <select name="categorie" required className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-base focus:outline-none focus:ring-1 focus:ring-gold/50 focus:border-gold">
            ...
            <div>
              ...
              <input type="url" name="url" placeholder="https://..." className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-base focus:outline-none focus:ring-1 focus:ring-gold/50 focus:border-gold" />
            </div>
          </div>
