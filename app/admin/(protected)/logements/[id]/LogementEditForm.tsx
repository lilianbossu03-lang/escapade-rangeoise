        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="sm:col-span-2">
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-sm focus:outline-none focus:border-gold"
            />
          </div>
          <div className="sm:col-span-2">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-sm focus:outline-none focus:border-gold resize-none"
            />
          </div>
          <div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex gap-2 mb-5">
          <input
            ...
            className="flex-1 border border-gray-200 rounded-xl px-3 py-2.5 font-lato text-sm focus:outline-none focus:border-gold"
          />
          <button
            type="button"
            onClick={addEquip}
